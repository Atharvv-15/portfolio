...
const Acheivements = () => {
    return (
        <div className='mt-[5rem] h-auto w-[900px] md:w-[720px] border'>
            <div className='stroke-yellow-300 text-[2rem] text-left md:text-[4rem] font-extrabold z-0 opacity-80 text-transparent' style={{ strokeWidth: "1.5px", WebkitTextStrokeWidth: "1.9px", WebkitTextStrokeColor: "yellow" }}>
                {"<"}Achievements {"/>"}
            </div>
            <div className='w-[85%] mt-10 mx-auto border md:p-2 border-opacity-70 rounded-md border-slate-500 ml-0'>
                <div>
