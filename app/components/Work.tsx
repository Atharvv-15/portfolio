...
const Work = () => {
  return (
    <div className='mt-[5rem] h-auto w-[330px] md:w-[1000px] ml-0'>
      <div className='stroke-yellow-300  text-[2rem] md:text-[4rem] font-extrabold z-0 opacity-80 text-transparent' style={{ strokeWidth: "1.5px", WebkitTextStrokeWidth: "1.9px", WebkitTextStrokeColor: "yellow" }}>
        {"<"}Work {"/>"}
      </div>
      <div className='grid grid-cols-1 md:grid-cols-2 gap-1 m-2 justify-center ml-0'>
